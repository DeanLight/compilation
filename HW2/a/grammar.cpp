...
std::vector<grammar_rule> make_grammar() {
	...
	res.push_back(grammar_rule(Exp,std::vector<int>(1,INTEGER))); // RULE 11
	res.push_back(grammar_rule(Exp,std::vector<int>(1,REAL))); // RULE 12
	res.push_back(grammar_rule(Exp,std::vector<int>(1,STRING))); // RULE 13
	res.push_back(grammar_rule(Exp,std::vector<int>(1,TRUE))); // RULE 14
	res.push_back(grammar_rule(Exp,std::vector<int>(1,FALSE))); // RULE 15
	res.push_back(grammar_rule(Exp,std::vector<int>(1,NUL))); // RULE 16
