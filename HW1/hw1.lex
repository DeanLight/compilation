...
CR \r
LF \n
ENDLINE (((CR)(LF))|CR|LF) // TODO - check the \+ operation is ok
ESCAPE_SEQ \\([nrtbf\(\)\\]|OCTAL3) // TODO - check about ecaping parenthesis 
ALPHANUM [a-zA-Z0-9]
...
<RAW_STRING_STATE>END_RAW_STR BEGIN(INITIAL) // TODO
